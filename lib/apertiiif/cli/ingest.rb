...
COLLECTION_NAMESPACE    = File.basename(FileUtils.pwd).gsub(SERVICE_NAMESPACE, '').freeze

SRC_DIR                 = 'src'
BUILD_DIR               = 'build'
IMAGE_BUILD_DIR         = "#{BUILD_DIR}/image".freeze
PRESENTATION_BUILD_DIR  = "#{BUILD_DIR}/presentation".freeze
